...
<body>
  ...
  <form id="shipment" class="shipment-info">
    ...
    <input id="serviceprice" type="number" placeholder="Service Price" value="<?php echo $_SESSION['packages_arr']['records'][0]['service_price']; ?>" readonly>
  ...
  elseif( $_SESSION['packages_arr']['records'][0]['delivery_type'] == 2){
    ...
    <input id="deliveryprice" type="number" placeholder="Delivery Price" value="<?php echo $_SESSION['packages_arr']['records'][0]['delivery_price']; ?>" readonly>
...
<!-- Display total price for courirer -->
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="footer-bottom__left">
          <a href="#">Fastrack Express </a> A delivery service you can depend on.
        </div>
