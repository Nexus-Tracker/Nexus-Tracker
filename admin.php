    ...
    <div class="container">
      ...
      <nav class="top__menu" role="navigation" aria-label="Top Menu">
        <ul id="menu-top-menu" class="top-navigation  js-dropdown" role="menubar">
          <li id="menu-item-609" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-609"><a href="index.html">Home</a></li>
  ...
  <table>
    ...
    <tbody id="table-container">
      <tr>
        ...
        <td>DELIVERY LOCATION</td>
        <td>STATUS</td>
        <td><a href="ad-view.php?tracking_no=FASTRACK2023123456">View Details</a></td>
        <td><a href="edit.php">Edit</a></td>
        <td><button id="deleteBtn"><a href="./server/api/delpackage.php?tracking_no">Delete</a></button></td>

      </tr>
    </tbody>
  </table>
  <scripts src="admin.js"></scripts>
