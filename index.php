...
<body>
  ...
  <li id="menu-item-596" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-596" aria-haspopup="true" aria-expanded="false" tabindex="0"><a href="">What We Do</a>
  ...
  <ul class="sub-menu" role="menu">
    ...
    <li id="menu-item-601" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-601"><a href="tracing.php">Trucking Service</a></li>
    <li id="menu-item-602" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-602"><a href="">Storage</a></li>
  </ul>
  </li>
  
  <li id="menu-item-607" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-607"><a href="tracking.php">Tracking</a></li>
  ...
  <div class="header__widgets">
    ...
    <div class="widget  widget_text"> 
      ...
      <a class="btn   btn-primary    href="tracking.html">Track Your Shipment</a>
      </div>
      </div>
      </div>
      </header> 
		...
		<div class="carousel  slide  js-jumbotron-slider" id="headerCarousel" data-ride="carousel" data-interval="5000">
			...
			<!-- Wrapper for slides -->
				...
				<div class="item  active">
									<img src="assets/slider_1_1920.jpg" srcset="" sizes="100vw" >
													<div class="container">
	...
	<div class="w69b-screencastify-mouse"></div>
				...
				<div class="item ">
									<img src="assets/slider_2_1920.jpg" srcset="" sizes="100vw" alt="CRANE TO TRAIN, WE DO EVERYTHING">
													<div class="container">
						<div class="jumbotron-content">
												<div class="jumbotron-content__title">
	...
	<div class="w69b-screencastify-mouse"></div>
				...
				<div class="item ">
									<img src="assets/slider_3_1920.jpg" srcset="" sizes="100vw" alt="GROUND OR AIR, THERE IS NO STOPPING FOR US">
													<div class="container">
						<div class="jumbotron-content">
												<div class="jumbotron-content__title">
...
<p><a class="read-more" href="about.html">MORE ABOUT US</a></p>
	...
	<div class="page-box  page-box--block">
		<a class="page-box__picture" href=""><img width="360" height="240" src="assets/logistic.jpg" class="attachment-pw-page-box size-pw-page-box wp-post-image" alt="" loading="lazy" srcset="" sizes="(max-width: 360px) 100vw, 360px"></a>
	...
	<div class="page-box  page-box--block">
		<a class="page-box__picture" href=""><img width="360" height="240" src="assets/storage.jpg" class="attachment-pw-page-box size-pw-page-box wp-post-image" alt="" loading="lazy" srcset="" sizes="(max-width: 360px) 100vw, 360px"></a>
		<div class="page-box__content">
		...
		<span class="icon-box__subtitle">Transport your things with our super moving vans.</span>
			...
			<a href="" class="latest-news  latest-news--block">
				...
				<div class="latest-news__image">
					<img width="848" height="480" src="assets/storage.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" loading="lazy" srcset="" sizes="(max-width: 848px) 100vw, 848px">
				</div>
...
<div id="panel-6-4-1-0" class="so-panel widget widget_pw_latest_news widget-latest-news panel-first-child panel-last-child" data-index="13">
			...
			<a href=" class="latest-news  latest-news--block">
				...
				<div class="latest-news__image">
					<img width="1920" height="600" src="assets/cargo.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" loading="lazy" srcset="" sizes="(max-width: 1920px) 100vw, 1920px">
				</div>
			...
			<a href="" class="latest-news  latest-news--inline">
				<div class="latest-news__content">
...
<p style="text-align: center;"><a><img class=" size-full wp-image-344 aligncenter" src="assets/ok.png" alt="signature" width="232" height="58"></a></p>
</div></div></div>
...
<div class="col-xs-12  col-md-6">
     ...
     <img src="assets/captcha_code_file.jpeg" id='captchaimg' ><br>
...
<div id="pg-6-7" class="panel-grid panel-has-style"><div class="siteorigin-panels-stretch panel-row-style panel-row-style-for-6-7" data-stretch-type="full"><div id="pgc-6-7-0" class="panel-grid-cell"><div id="panel-6-7-0-0" class="so-panel widget widget_pw_testimonials widget-testimonials panel-first-child panel-last-child" data-index="18"><div class="widget-title--big panel-widget-style panel-widget-style-for-6-7-0-0">
  ...
  <div class="row">
    <div class="col-xs-12  col-sm-2">
      <img src="assets/transport.png" alt="Client">
    </div>
    <div class="col-xs-12  col-sm-2">
      <img src="assets/transglobal.png" alt="Client">
    </div>
    <div class="col-xs-12  col-sm-2">
      <img src="assets/t3.png" alt="Client">
    </div>
    <div class="col-xs-12  col-sm-2">
      <img src="assets/t4.png" alt="Client">
    </div>
    <div class="col-xs-12  col-sm-2">
      <img src="assets/t5.png" alt="Client">
    </div>
    <div class="col-xs-12  col-sm-2">
      <img src="assets/t6.png" alt="Client">
    </div>
  </div>
</div></div>
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-25"><a rel="noopener" href="about.html">About Us</a></li>
...
<li id="menu-item-112" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-112"><a href="">Ground Transport</a></li>

<li id="menu-item-113" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-113"><a href="">Cargo</a></li>

<li id="menu-item-114" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-114"><a href="">Warehousing</a></li>

<li id="menu-item-115" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-115"><a href="">Logistic Service</a></li>

<li id="menu-item-116" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-116"><a href="">Trucking Service</a></li>

<li id="menu-item-117" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-117"><a href="">Storage</a></li>
